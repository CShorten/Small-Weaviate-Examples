...
func main() {
	...
	// ChatGPT, can we refactor the following map construction and instantiation into more compact code?

	index_to_filter_map := make(map[int]int)
	index_to_filter_map[0] = 0
	index_to_filter_map[1] = 0
	index_to_filter_map[2] = 1
	index_to_filter_map[3] = 1
	index_to_filter_map[4] = 2
	index_to_filter_map[5] = 2
	index_to_filter_map[6] = 3
	index_to_filter_map[7] = 3
	index_to_filter_map[8] = 3
	index_to_filter_map[9] = 3
	index_to_filter_map[10] = 4
	index_to_filter_map[11] = 4
	index_to_filter_map[12] = 4
	index_to_filter_map[13] = 4
	index_to_filter_map[14] = 4
	index_to_filter_map[15] = 4
	index_to_filter_map[16] = 4
	index_to_filter_map[17] = 4
	index_to_filter_map[18] = 4
	index_to_filter_map[19] = 4
	...
	for idx, queryVector := range queryVectors {
		...
		queryFilters[0] = index_to_filter_map[idx]
